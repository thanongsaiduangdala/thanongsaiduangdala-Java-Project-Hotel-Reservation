 ...
 * @author sunny
 */
public class Lao_Poet_Hotel_Check_Room extends javax.swing.JFrame {
...
int R10C4= 0;
    ...
    public Lao_Poet_Hotel_Check_Room() {
        initComponents();
...
jLabel17.setForeground(Color.LIGHT_GRAY);
    ...
    int IDtrue;
    public Lao_Poet_Hotel_Check_Room(int ID){
    initComponents();
        IDAdmin = ID;
...
YRTL10.setVisible(false);
   ...
   jLabel17.setForeground(Color.LIGHT_GRAY);     
    ...
    public Lao_Poet_Hotel_Check_Room(int Room, int CID, int COD){
     initComponents();
...
if (Out32.isSelected() || In32.isSelected()){
 ...
 String Monthin =  (String) ComInMonth.getSelectedItem();
        ...
        JOptionPane.showMessageDialog(null, "Please check if you have select the Room selection and the date selection");
            ...
            if( IDtrue == 0){
        new Lao_Poet_Hotel_CheckOutPage(RoomIDGot, date, dataOut, showDateCID, showDateCOD, GetBedSelect, d).setVisible(true);
            this.setVisible(false);}
            else if(IDtrue == 1){
             new Lao_Poet_Hotel_CheckOutPage(RoomIDGot, date, dataOut, showDateCID, showDateCOD, GetBedSelect, d, IDAdmin).setVisible(true);
            this.setVisible(false);
            }
        }
 ...
 if (R10C4== 1){ C4.setBackground(Color.red);C4.setEnabled(false);}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lao_Poet_Hotel_Check_Room.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
